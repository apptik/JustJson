...
public class DateGenerator extends JsonGenerator {

    public DateGenerator(Schema schema, JsonGeneratorConfig configuration) {
        super(schema, configuration);
    }

    public DateGenerator(Schema schema, JsonGeneratorConfig configuration, String propertyName) {
