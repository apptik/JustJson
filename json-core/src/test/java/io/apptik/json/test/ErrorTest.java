...
public class ErrorTest {
    ...
    public static String malformedObject1() {
        return "{\n" +
                "    \"store\": {\n" +
                "        \"book\"" +
                //": " +
    ...
    public static String malformedObject2() {
        return "{\n" +
                "    \"store\": {\n" +
                "        \"book\": [\n" +
                "            {\n" +
    ...
    public static String malformedObject3() {
        return "{\n" +
                "    \"store\": {\n" +
                "        \"book\": [\n" +
                "            {\n" +
    ...
    public static String malformedObject4() {
        return "{\n" +
                "    \"store\": {\n" +
                "        \"book\": [\n" +
                "            {\n" +
    ...
    public static String malformedObject5() {
        return "{\n" +
                "    \"store\": {\n" +
                "        \"book\": [\n" +
                "            {\n" +
    ...
    public static String unexpectedEndObject() {
        return "{\n" +
                "    \"store\": {\n" +
                "        \"book\": [\n" +
                "            {\n" +
    ...
    public static String malformedArray1() {
        return "[\n" +
                "            {\n" +
                "                \"category\": \"reference\",\n" +
                "                \"author\"" +
    ...
    public static String malformedArray2() {
        return "[\n" +
                "            {\n" +
                "                \"category\": \"reference\",\n" +
                "                \"author\": \"Nigel Rees\",\n" +
    ...
    public static String malformedArray3() {
        return "[\n" +
                "            {\n" +
                "                \"category\": \"reference\",\n" +
                "                \"author\": \"Nigel Rees\",\n" +
    ...
    @Test
    public void unexpectedEndOfObject() {
        String obj = "{\"foo\":[5,[]]";
        try {
            JsonElement.readFrom(obj);
            fail("must fail");
    ...
    @Test
    public void malformedArrayInObject() {
        String obj = "{\"foo\":[5,10,9,8,7,6,[]}";
        try {
            JsonElement.readFrom(obj);
            fail("must fail");
        } catch (IOException e) {
